...
<span style="color: #2E5A8C;">My research examines how artificial intelligence (AI) transforms human expertise, work, and organizations.</span> Grounded primarily in <span style="color: #2E5A8C; font-weight: 600;">healthcare</span>, I study how AI reshapes care delivery, workforce dynamics, and organizational outcomes. I draw on causal inference, machine learning, natural language processing (NLP), and LLM-based methods, applied to large-scale administrative and healthcare data, at the intersection of information systems and operations management.
